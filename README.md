...
![GitHub last commit (branch)](https://img.shields.io/github/last-commit/rodolphe37/my-simple-tutorial-creator/main)
<img   src="https://badges.aleen42.com/src/react.svg" alt="drawing" height="20" width="65"/>

[![Website](https://i.imgur.com/xSu6S5v.png)](https://rodolphe-augusto.fr)
[![Netlify Status](https://api.netlify.com/api/v1/badges/6d270a29-eb7d-4aa4-b93a-46add17b6425/deploy-status)](https://app.netlify.com/sites/mystifying-hugle-40a501/deploys)

# User Guide

---

## <img  style =" float: left; margin-right: 22px " src="demo/camcorder.svg" alt="drawing" height="50" width="50"/>My Simple Tutorial Creator_V1.0.0
